...
**Выполнила** : Петрова Анна (100 гр.) <sup>1</sup>
...
---
<sup>1</sup> Заполните свою фамилию.

<sup>2</sup> Это пример оформления варианта. Вам следует заменить его на описание выданного вам варианта.
